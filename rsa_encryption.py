...
# ----------------------------------
# next prime is the function find out the next available prime number after we pick a random number.
p = next_prime(
...
# Output:
'''
278952104372285737655568072733660369810369123684635371743211705805365968832818520061405283936660547548729567029875939975
86926782065707513258640857045583173311330580914700561150332760553355798496727220109017733816055040317120839997
'''
